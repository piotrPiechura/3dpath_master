...
function dodaj_selektor_trajektorii()//{{{
{
    ...
    var i;
    for(i=0;i<imdata;i++){
        console.log(mdata_o[i]);
        $('.menu_wells').append('<div class="chbList"><div class="ez-checkbox ez-checked"><input id="menu_well_'+i+'"   name="menu_well_'+i+'"  checked="checked"  value="'+i+'" class="checkboxIt ez-hide" type="checkbox">'
        +'</div><label class="checkbox-ez-custom"  >'+mdata_o[i]+'</label></div>');
    }

    //$('.menu_wells').append('<input class="trajektoria_item" value="'+i+'" type="checkbox" checked="checked">'+mdata_o[i]+'<br>');
}//}}}
