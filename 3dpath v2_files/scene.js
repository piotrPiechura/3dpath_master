...
//function set_menu()
{
	...
	if(wykres.menu_1==1)
		document.getElementById('menu_1').className='btn-on';
	else
		document.getElementById('menu_1').className='btn-off';

	if(wykres.menu_2==1)
		document.getElementById('menu_2').className='btn-on';
	else
		document.getElementById('menu_2').className='btn-off';

	if(wykres.menu_3==1)
		document.getElementById('menu_3').className='btn-on';
	else
		document.getElementById('menu_3').className='btn-off';
		
	if(wykres.menu_4==1)
		document.getElementById('menu_4').className='btn-on';
	else
		document.getElementById('menu_4').className='btn-off';
		
	if(wykres.menu_2_1==1)
		document.getElementById("menu_2_1").checked=true;
	else
		document.getElementById("menu_2_1").checked=false;

	if(wykres.menu_2_2==1)
		document.getElementById("menu_2_2").checked=true;
	else
		document.getElementById("menu_2_2").checked=false;

	if(wykres.menu_2_3==1)
		document.getElementById("menu_2_3").checked=true;
	else
		document.getElementById("menu_2_3").checked=false;

	if(wykres.menu_camera==2)
	{
		document.getElementById('ortho_east').className='btn-on';
		document.getElementById('ortho_north').className='btn-on';
		document.getElementById('ortho_tvd').className='btn-on';
	}
	else
	{
		document.getElementById('ortho_east').className='btn-off';
		document.getElementById('ortho_north').className='btn-off';
		document.getElementById('ortho_tvd').className='btn-off';
	}
