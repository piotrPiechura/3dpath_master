    ...
    <div class="content">
                ...
                <div class="col-md-6">
                  <h4>General Information</h4>  
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            {$_form->field('siteName', null, 'maxlength="255"',"form-control")}
                     ...
                     <div class="form-group">
                        ...
                        <div class="controls">
                            {$_form->field('siteDistrict', null, 'maxlength="255"',"form-control")}
                     ...
                     <div class="form-group">
                        ...
                        {*<span class="help">e.g. "First Site"</span>*}
                        <div class="controls">
                            {$_form->field('siteBlock', null, 'maxlength="255"',"form-control")}
                     ...
                     <div class="form-group">
                        ...
                        {*<span class="help">e.g. "First Site"</span>*}
                        <div class="controls">
                            {$_form->field('siteElevation', null, 'maxlength="11"',"form-control")}
                ...
                <div class="col-md-6">
                  ...
                  <h4>Location Information</h4>
                    <div class="form-group">
                        ...
                        {*<span class="help">e.g. "First Site"</span>*}
                        <div class="controls">
                            {$_form->field('siteLocation', null, 'maxlength="11"',"form-control")}
                    ...
                    <div class="form-group">
                        ...
                        {*<span class="help">e.g. "First Site"</span>*}
                        <div class="controls">
                            {$_form->field('siteTeditNorthing', null, 'maxlength="11"',"form-control")}
                    ...
                    <div class="form-group">
                        ...
                        {*<span class="help">e.g. "First Site"</span>*}
                        <div class="controls">
                            {$_form->field('siteTeditEasting', null, 'maxlength="11"',"form-control")}
      ...
      {if !empty($recordId)}
       <div class="row"> 
        <div class="col-md-12 nocsroll">
           <div class="grid simple">
                    ...
                    <form id="slotForm" method="post" action="" enctype="multipart/form-data">
                        <div class="col-md-3">
                                    ...
                                    <div class="form-group" id="grp_Name">
                                        <label class="form-label">{#NameFieldCaption#}</label>
                   ...
                   <div class="form-group">
                            ...
                            <div class="form-group varField" id="grp_DLS2">
                             ...
                             <div class="form-group" id="grp_targetInclination">
                                   <label class="form-label">{#targetInclinationFieldCaption#}</label>
                                   <span class="help"></span>
                                   <div class="controls">
                            ...
                            <div class="form-group" id="grp_targetAzimuth">
                                   <label class="form-label">{#targetAzimuthFieldCaption#}</label>
                                   <span class="help"></span>
                                   <div class="controls">
				...
				<thead>
                                    <tr>
					<th style="width:12%" class="text-center">{#deltaXFieldCaption#}</th>
					<th style="width:22%" class="text-center">{#deltaYFieldCaption#}</th>
					<th style="width:6%" class="text-center">{#deltaZFieldCaption#}</th>
                                    </tr>
				</thead>
				<tbody>
                                    <tr class="">
                                   ...
                                   <div class="col-md-3">
                                    <div class="form-group" id="grp_SR">   
                                        <table class="slotDirections">
                                            <label class="form-label">{#SideFieldCaption#}</label>
                                            <span class="help"></span>
                                      ...
                                      <div class="form-group" id="grp_Azimuth">
                                        ...
                                        <div class="form-group" id="grp_SR">
                                            <label class="form-label">{#SRFieldCaption#}</label>
                                            <span class="help"></span>
                                            <div class="controls">
                                    ...
                                    <div class="form-group" id="grp_SR">
                                            <label class="form-label">{#STFieldCaption#}</label>
                                            <span class="help"></span>
                                            <div class="controls">
                                    ...
                                    <div class="form-group" id="grp_SM">
                                            <label class="form-label">{#SMFieldCaption#}</label>
                                            <span class="help"></span>
                                            <div class="controls">
                                    ...
                                    <div class="form-group" id="grp_NOS">
                                            <label class="form-label">{#NOSFieldCaption#}</label>
                                            <span class="help"></span>
                                            <div class="controls">
       ...
       <script>
                ...
                $("#slotSubmit").on('click', function(e){
                   ...
                   if (allFieldsFiled == true){ 
                    var dataToSend = {
                        ...
                        SiteId: {/literal}{$recordId}{literal}
                    };
        ...
        {include file='common/cms_3drenderSite.tpl'}
