...
function init() 
{
	...
	var VIEW_ANGLE = 60, ASPECT = SCREEN_WIDTH / SCREEN_HEIGHT, NEAR = 0.1, FAR = 2000;
        ...
        //camera = new THREE.CombinedCamera(  -SCREEN_WIDTH ,-SCREEN_WIDTH , -SCREEN_HEIGHT , -SCREEN_HEIGHT , 90, 2000  );
          camera = new THREE.CombinedCamera( SCREEN_WIDTH, SCREEN_WIDTH, 70, 1, 1000, -500, 1000 );
...
$(document).ready(function(){
    ...
    $("#viewTop").click(function(e){
        ...
        camera.toTopView();
        lookAtScene=false;
        camera.position.set(0.005,524.41,0.0000000);
...
{/literal}
                             ...
                             <div style=" display: block;left: 800px;margin-right: 600px;position: relative; top: -600px; z-index:999">
                            View: <br/>
                            {*<ul>
