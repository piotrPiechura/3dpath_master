...
<head>
    ...
    <link href="assets/plugins/jquery-slider/css/jquery.sidr.light.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" type="text/css" media="all" href="assets/css/admin_style.css" />
    <link rel="stylesheet" type="text/css" media="all" href="assets/css/orange.css" />
    <link rel="stylesheet" type="text/css" media="all" href="assets/css/jquery-ui-1.10.3.custom.css" />
    <link rel="stylesheet" type="text/css" media="all" href="assets/css/ezmark.css" />
    <link rel="stylesheet" type="text/css" media="all" href="assets/css/styletooltips-range.css" />
